...
print(str(test(ListNode.create_lists([[1,4,5], [1,3,4], [2,6]]))))
print(str(test(ListNode.create_lists([]))))
print(str(test(ListNode.create_lists([[]]))))
print(str(test(ListNode.create_lists([[1]]))))
print(str(test(ListNode.create_lists([[0,2,5]]))))
print(str(test(ListNode.create_lists([[-10,-9,-9,-3,-1,-1,0],[-5],[4],[-8],[],[-9,-6,-5,-4,-2,2,3],[-3,-3,-2,-1,0]]))))
print(str(test(ListNode.create_lists([[-8,-7,-6,-3,-2,-2,0,3],[-10,-6,-4,-4,-4,-2,-1,4],[-10,-9,-8,-8,-6],[-10,0,4]]))))
